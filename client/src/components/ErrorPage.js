...
class ErrorPage extends React.Component {
  ...
  render() {
    return (
        <div class="vh-100 bg-washed-blue baskerville">
        <header class="tc ph5 lh-copy">
            <h1 class="f1 f-headline-l code mb3 fw9 dib tracked-tight light-purple"><span>oOPS!!</span> 404</h1>
        ...
        <ul class="list tc pl0 w-100 mt5">
          ...
          <li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/affiliate">Affiliate</a></li>
          <li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/contact">Contact</a></li>
          <li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/sign_up">Sign Up</a></li>
        </ul>
      </div>
    );
  }
