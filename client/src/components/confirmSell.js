...
import {
  ...
  Nav,
  NavItem,
  NavLink,Button, Form, FormGroup, Label, Input, FormText,
  ...
  let btcamount = JSON.parse(window.localStorage.getItem("btcamount"));
    ...
    return (
      ...
      expand="lg">
        ...
        <h3>Send Coin to Any of These Wallet Addresses</h3><br></br>
    ...
    <Form>
      ...
      <FormGroup>
        ...
        <Input type="text" name="" id="exampleEmail" placeholder="Your account name" />
      </FormGroup>
      </Form>
